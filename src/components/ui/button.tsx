  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        generate: "bg-button-generate text-button-generate-foreground hover:bg-button-generate/90 rounded-lg hover:shadow-lg active:scale-95",
        pill: "bg-button-secondary text-button-secondary-foreground hover:bg-muted rounded-full border border-border hover:shadow-md active:scale-95",
        chat: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-full hover:shadow-xl active:scale-95 border-2 border-primary/20 shadow-lg",
      },
      size: {
